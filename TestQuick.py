...
# QuickSNMP.set( agent_address, {'1.3.6.1.2.1.1.5.0': 'SNMPHost'}, hlapi.CommunityData( community_name ) )

# Using SNMPv2c, we retrieve the hostname of the remote device
print( QuickSNMP.get( agent_address, ['1.3.6.1.2.1.1.5.0'], hlapi.CommunityData( community_name ) ) )
